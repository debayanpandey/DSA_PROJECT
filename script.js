...
function updateMasterGain() {
    ...
    let finalGain = 1.0;
    if (window.innerWidth <= 768) {
        finalGain = 6.0; // Strong mobile output gain
    } else if (window.innerWidth <= 1024) {
        finalGain = 3.0; // Tablet output gain
    }
...
function playStopSound() {
    ...
    gainNode.gain.linearRampToValueAtTime(volume * 0.25, now + 0.03); // smooth attack, slightly softer
